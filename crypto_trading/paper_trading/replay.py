...
def run_replay(
    ...
    tidsordnad lista handkonstruerade snapshots. Look-ahead-bias-fritt
    (SPEC §8.4): varje steg skickar bara evaluated_at=snapshot.simulated_now
    ...
    for snapshot in ordered:
        ...
        processed = run_discovery_cycle(repo, runner, settings, run_id)
